...
public class RestAssuredConstants {
  ...
  private static final LogConfig LOG_ALL_IF_VALIDATION_FAILS =
  ...
  private static final Filter ALLURE_REST_ASSURED_FILTER =
  ...
  public static final RequestSpecification BASIC_REQUEST_SPECIFICATION =
      getDefaultRequestBuilder().build();

  private RestAssuredConstants() {}

  private static RequestSpecBuilder getDefaultRequestBuilder() {
    RequestSpecBuilder requestSpecBuilder =
        new RequestSpecBuilder().setConfig(CONFIG).addFilter(ALLURE_REST_ASSURED_FILTER);
